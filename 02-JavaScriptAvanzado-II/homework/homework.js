...
function counter() { // | Hecho por el instructor
...
function cacheFunction(cb) { // Hecho por los companieros de standup
  ...
  // si invocas la function que retornaste con 5, adentro deberia invocar cb(5) y retornar 10.
  // si la invocas de nuevo con 5, deberia retornar 10 (guardado previament en el cache)
...
// | Hecho por el instructor (todo lo de abajo)
